let musicDB = [
    {
        ...
        author_name: "DJ TENEBROSO",
        img: "dj tenebros.png",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "electronic",
        musicName: "MONTAGEM ORQUESTRA.mp3",
        attribution: {
            song: "MONTAGEM ORQUESTRA SINFÔNICA",
            musicBy: "DJ TENEBROSO",
            download: "http://ssyoutube.com/watch?v=XWdWWBiVdqM",
            stream: null
        }
    },
    {
        id: 1,
        name: "ASUR 2 bgm",
        author_name: "Gaurav Shukla",
        img: "asur2.png",
        lang: "HINDI",
        timesPlayed: 0,
        type:"instrumental",
        musicName: "Asur Bgm.mp3",
        attribution: {
            song: "ASUR 2 bgm",
            musicBy: "Gaurav Shukla",
            download: "https://ssyoutube.com/watch?v=rmnJ7XcYxLc",
            stream: null
        }
    },
    {
        id: 2,
        name: "Gasolina",
        author_name: " Daddy Yankee",
        img: "gasolinadd.png",
        lang: "ENGLISH",
        type: "electronic",
        timesPlayed: 0,
        musicName: "Gasolina.mp3",
        attribution: {
            song: "GASOLINA - Feat. DADDY YANKEE",
            musicBy: "Eddie Dee",
            download: "https://ssyoutube.com/watch?v=3tw2P65wv5E",
            stream: null
        }
    },
    {
        id: 3,
        name: "Jalebi Baby",
        author_name: "Tesher x Jason Derulo",
        img: "jalabibaby.png",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "electronic",
        musicName: "Tesher x Jason Derulo  Jalebi Baby.mp3",
        attribution: {
            song: "Jalebi Baby",
            musicBy: "Tesher x Jason Derulo",
            download: "https://ssyoutube.com/watch?v=CTmKrwFu7wg",
            stream: null
        }
    },
    {
        id: 4,
        name: "Clandestina",
        author_name: "Youssef Akdim",
        img: "Clandestina.png",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "electronic",
        musicName: "JVSTIN  CLANDESTINA.mp3",
        attribution: {
            song: "Clandestina Remix",
            musicBy: "Youssef Akdim",
            download: "https://ssyoutube.com/watch?v=lYcSc57pc2U",
            stream: null
        }
    },
    {
        id: 5,
        name: "NF - The Search",
        author_name: "Tommee Profitt",
        img: "thesearch.png",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "electronic",
        musicName: "NF  The Search lyrics.mp3",
        attribution: {
            song: "NF - The Search",
            musicBy: "Tommee Profitt",
            download: "https://ssyoutube.com/watch?v=fnlJw9H0xAM",
            stream: null
        }
    },
    {
        id: 6,
        name: "Kenny G - The Moment",
        author_name: "Kenny G",
        img: "Kenny G - The Moment.png",
        lang: "ENGLISH",
        timesPlayed: 0,
        type:"instrumental",
        musicName: "Kenny G  The Moment Official Video.mp3",
        attribution: {
            song: "Kenny G - The Moment",
            musicBy: "Kenny G",
            download: "https://ssyoutube.com/watch?v=447yaU_4DF8",
            stream: null
        }
    },
    {
        ...
        timesPlayed: 0,
        type:"instrumental",
        musicName: "Boney M  Rasputin Official Instrumental HQ.mp3",
        attribution: {
            song: "Rasputin",
            musicBy: "Kenny G",
            download: "http://ssyoutube.com/watch?v=kJPJT276ksE",
            stream: null
        }
    },
    {
        id: 8,
        name: "Mahabharat ki katha",
        author_name: "Parvathy Kapoor",
        img: "mahabharat.png",
        lang: "HINDI",
        timesPlayed: 0,
        type: "electronic",
        musicName: "Mahabharat ki katha.mp3",
        attribution: {
            song: "Mahabharat ki katha",
            musicBy: "Parvathy Kapoor",
            download: "https://ssyoutube.com/watch?v=1jpPWA7HuAk",
            stream: null
        }
    }
];
